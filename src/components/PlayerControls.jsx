...
function PlayerControls(props) {
  return (
    <div className='mt-10'>
        <button className='mr-10 cursor-pointer' onClick={() => props.SkipSong()}><FontAwesomeIcon icon={faBackward} /></button>
       ...
       <button className='cursor-pointer' onClick={() => props.SkipSong()}><FontAwesomeIcon icon={faForward} /></button>   
    </div>
  )
}
