    ...
    <div className="welcome_main_container">
      <div className="absolute w-full h-screen flex bg-black bg-opacity-70 justify-center items-center flex-col">
        <button
          ...
          className="absolute rounded-2xl p-4 bg-white cursor-pointer buttonUniversal ml-[-22%] mt-[49%] lg:ml-[8%] lg:mt-[33%] lg:rotate-[90deg]"
        >
          Click Here To Vibe
        </button>
        {showPopup && (
          <div className="bg-black absolute text-white w-full h-screen bg-opacity-40 flex flex-col justify-center items-center overflow-hidden">
            <div className="bg-gradient-to-r from-gray-700 via-gray-900 to-black lg:h-[60%] lg:w-[20%] h-[50%] w-[80%] text-white rounded-2xl">
              <button
                className="bg-white text-[80%] mt-4 text-black lg:ml-[85%] ml-[85%] pt-[0.5%] pb-0 pr-[1.7%] pl-[1.9%] rounded-2xl"
                onClick={handleButtonClick}
              >
                <FontAwesomeIcon icon={faClose} />
              </button>
              <h1 className="absolute mt-4 lg:ml-[1%] lg:mr-[40.8%] ml-11 mr-[20%] text-center lg:mt-7 uppercase">
                Discover the Healing Melodies!
              </h1>
              <p className="absolute lg:mt-[7%] mt-[25%] ml-8 lg:ml-[2%] lg:mr-[42%] mr-[18%] text-justify text-[80%]">
              ...
              <img
                className="lg:w-[30%] mt-[46%] lg:mt-[8%] ml-[10%] lg:ml-[7%] overflow-hidden absolute"
                src="/images/danny.png"
              />
            </div>
          </div>
        )}
        <img className="w-[50%] overflow-hidden" src="/images/NightVibe.png" />
      </div>
